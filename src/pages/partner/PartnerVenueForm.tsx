...
import { useIsPartner, useCreatePartnerVenue, useUpdatePartnerVenue, usePartnerVenues } from '@/hooks/usePartner';
...
export default function PartnerVenueForm() {
  ...
  if (!user) {
    return <Navigate to="/auth?redirect=/partner/venues/new" replace />;
  }
