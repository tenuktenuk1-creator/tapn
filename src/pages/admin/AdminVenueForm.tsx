...
export default function AdminVenueForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Build opening_hours: exclude null days (closed), keep only open days
    ...
    let error;
    if (isEditing) {
      ({ error } = await supabase.from('venues').update(venueData).eq('id', id));
    } else {
          ...
          <div className="card-dark rounded-2xl p-6 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea id="description" value={formData.description} onChange={(e) => setFormData(prev => ({ ...prev, description: e.target.value }))} rows={4} className="bg-secondary border-border" />
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="city" value={formData.city} onChange={(e) => setFormData(prev => ({ ...prev, city: e.target.value }))} required className="bg-secondary border-border" />
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="price_per_hour" type="number" value={formData.price_per_hour} onChange={(e) => setFormData(prev => ({ ...prev, price_per_hour: e.target.value }))} className="bg-secondary border-border" />
              </div>
            </div>
                      ...
                      {isOpen && hours ? (
                        <>
                          <Input
                            ...
                            className="bg-secondary border-border h-8 text-sm w-32"
                          />
